...
Begin DesignProperties = 
   ...
   Begin DataPane = 
      ...
      Begin ColumnWidths = 38
         ...
         Width = 1500
         Width = 1500
         Width = 1500', @level0type = N'SCHEMA', @level0name = N'catalog', @level1type = N'VIEW', @level1name = N'dn_Plans';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'End
   ...
   Begin CriteriaPane = 
      ...
      End
   End
End', @level0type = N'SCHEMA', @level0name = N'catalog', @level1type = N'VIEW', @level1name = N'dn_Plans';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'catalog', @level1type = N'VIEW', @level1name = N'dn_Plans';
