...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         Column = 1440
         Alias = 900
         Table =', 'SCHEMA', N'logging', 'VIEW', N'catalogload_deviceservice', NULL, NULL
GO
EXEC sp_addextendedproperty N'MS_DiagramPane2', N' 1170
   ...
   End
End
', 'SCHEMA', N'logging', 'VIEW', N'catalogload_deviceservice', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=2
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'logging', 'VIEW', N'catalogload_deviceservice', NULL, NULL
GO
