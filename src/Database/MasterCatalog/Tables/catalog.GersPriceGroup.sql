...
---------------------------------------------------------------------------- 
-- Object Type : Trigger
-- Object Name : msdb.tr_loggerspricegroup
-- Description : Monitor all changes in the catalog.gerspricegroup table
-- Author : Naomi Hall
-- Date : December 18th, 2012 -- Edited January 3, 2013
---------------------------------------------------------------------------- 

--The Trigger
CREATE TRIGGER [catalog].[tr_loggerspricegroup] ON [catalog].[GersPriceGroup] FOR INSERT, UPDATE, DELETE
...
SELECT @TableName = 'gerspricegroup'
...
SELECT @PKValue = a FROM @t2
	...
	END
GO
ALTER TABLE [catalog].[GersPriceGroup] ADD CONSTRAINT [PK_GersPriceGroup] PRIMARY KEY CLUSTERED  ([PriceGroupCode]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
EXEC sp_addextendedproperty N'MS_Description', N'List of acronyms (along with their definitions) found in the [catalog].[GersPrice] table.', 'SCHEMA', N'catalog', 'TABLE', N'GersPriceGroup', NULL, NULL
GO
EXEC sp_addextendedproperty N'CreateDate', N'20-SEP-2012', 'SCHEMA', N'catalog', 'TABLE', N'GersPriceGroup', 'COLUMN', N'PriceGroupCode'
GO
EXEC sp_addextendedproperty N'MS_Description', N'Primary key', 'SCHEMA', N'catalog', 'TABLE', N'GersPriceGroup', 'COLUMN', N'PriceGroupCode'
GO
EXEC sp_addextendedproperty N'CreateDate', N'20-SEP-2012', 'SCHEMA', N'catalog', 'TABLE', N'GersPriceGroup', 'COLUMN', N'PriceGroupDescription'
GO
EXEC sp_addextendedproperty N'MS_Description', N'Definition of code', 'SCHEMA', N'catalog', 'TABLE', N'GersPriceGroup', 'COLUMN', N'PriceGroupDescription'
GO
