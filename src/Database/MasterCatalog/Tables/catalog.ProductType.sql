...
---------------------------------------------------------------------------- 
-- Object Type : Trigger
-- Object Name : msdb.tr_logproducttype
-- Description : Monitor all changes in the catalog.producttype table
-- Author : Naomi Hall
-- Date : December 18th, 2012 -- Edited January 3, 2013
---------------------------------------------------------------------------- 

--The Trigger
CREATE TRIGGER [catalog].[tr_logproducttype] ON [catalog].[ProductType] FOR INSERT, UPDATE, DELETE
...
SELECT @PKValue = a FROM @t2
	...
	END
GO
ALTER TABLE [catalog].[ProductType] ADD CONSTRAINT [PK_ProductTypes] PRIMARY KEY CLUSTERED  ([ProductTypeId]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
EXEC sp_addextendedproperty N'MS_Description', N'Legend of ProductType values seen in the [catalog].[ProductGuid] table', 'SCHEMA', N'catalog', 'TABLE', N'ProductType', NULL, NULL
GO
EXEC sp_addextendedproperty N'CreateDate', N'25-SEP-2012', 'SCHEMA', N'catalog', 'TABLE', N'ProductType', 'COLUMN', N'ProductTypeId'
GO
EXEC sp_addextendedproperty N'MS_Description', N'Primary key', 'SCHEMA', N'catalog', 'TABLE', N'ProductType', 'COLUMN', N'ProductTypeId'
GO
EXEC sp_addextendedproperty N'Owner', N'Naomi Hall', 'SCHEMA', N'catalog', 'TABLE', N'ProductType', 'COLUMN', N'ProductTypeId'
GO
