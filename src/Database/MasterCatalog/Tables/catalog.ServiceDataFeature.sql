...
(
[ServiceDataFeatureId] [int] NOT NULL IDENTITY(1, 1),
...
---------------------------------------------------------------------------- 
-- Object Type : Trigger
-- Object Name : msdb.tr_logservicedatafeature
-- Description : Monitor all changes in the catalog.servicedatafeature table
-- Author : Naomi Hall
-- Date : December 18th, 2012 -- Edited January 3, 2013
---------------------------------------------------------------------------- 

--The Trigger
CREATE TRIGGER [catalog].[tr_logservicedatafeature] ON [catalog].[servicedatafeature] FOR INSERT, UPDATE, DELETE
...
SELECT @TableName = 'servicedatafeature'
...
SELECT @PKValue = a FROM @t
	...
	END
GO
ALTER TABLE [catalog].[ServiceDataFeature] ADD CONSTRAINT [PK__ServiceD__DF4C9D5702192B98] PRIMARY KEY CLUSTERED  ([ServiceDataFeatureId]) ON [PRIMARY]
GO
