...
(
[MarketGuid] [uniqueidentifier] NOT NULL ROWGUIDCOL CONSTRAINT [DF_CarrierMarket_MarketGuid] DEFAULT (newid()),
...
ALTER TABLE [catalog].[Market] WITH NOCHECK ADD
...
---------------------------------------------------------------------------- 
-- Object Type : Trigger
-- Object Name : msdb.tr_logmarket
-- Description : Monitor all changes in the catalog.market table
-- Author : Naomi Hall
-- Date : December 18th, 2012 -- Edited January 3, 2013
---------------------------------------------------------------------------- 

--The Trigger
CREATE TRIGGER [catalog].[tr_logmarket] ON [catalog].[market] FOR INSERT, UPDATE, DELETE
...
SELECT @PKValue = a FROM @t
	...
	END
GO
ALTER TABLE [catalog].[Market] ADD CONSTRAINT [PK_Market] PRIMARY KEY CLUSTERED  ([MarketGuid]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_Market] ON [catalog].[Market] ([MarketGuid]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO

EXEC sp_addextendedproperty N'MS_Description', N'Determines which markets carriers supply services for.', 'SCHEMA', N'catalog', 'TABLE', N'Market', NULL, NULL
GO
EXEC sp_addextendedproperty N'CreateDate', N'25-SEP-2012', 'SCHEMA', N'catalog', 'TABLE', N'Market', 'COLUMN', N'CarrierGuid'
GO
EXEC sp_addextendedproperty N'MS_Description', N'Link to Company table', 'SCHEMA', N'catalog', 'TABLE', N'Market', 'COLUMN', N'CarrierGuid'
GO
EXEC sp_addextendedproperty N'CreateDate', N'25-SEP-2012', 'SCHEMA', N'catalog', 'TABLE', N'Market', 'COLUMN', N'MarketGuid'
GO
EXEC sp_addextendedproperty N'MS_Description', N'Primary key', 'SCHEMA', N'catalog', 'TABLE', N'Market', 'COLUMN', N'MarketGuid'
GO
