...
[Active] [bit] NULL CONSTRAINT [DF__Property__Active__07ECDD10] DEFAULT ((0))
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
CREATE STATISTICS [_dta_stat_1751065374_6_2_1] ON [catalog].[Property] ([Name], [ProductGuid], [PropertyGuid])

GO
CREATE STATISTICS [_dta_stat_1751065374_1_2] ON [catalog].[Property] ([PropertyGuid], [ProductGuid])

CREATE NONCLUSTERED INDEX [_dta_index_Property_10_1751065374__K2_K6_K1_7] ON [catalog].[Property] ([ProductGuid], [Name], [PropertyGuid]) INCLUDE ([Value]) ON [PRIMARY]
...
---------------------------------------------------------------------------- 
-- Object Type : Trigger
-- Object Name : msdb.tr_logproperty
-- Description : Monitor all changes in the catalog.property table
-- Author : Naomi Hall
-- Date : December 18th, 2012 -- Edited January 3, 2013
---------------------------------------------------------------------------- 

--The Trigger
CREATE TRIGGER [catalog].[tr_logproperty] ON [catalog].[Property]
WITH EXECUTE AS 'WALLC\116773'
...
ALTER TABLE [catalog].[Property] ADD CONSTRAINT [PK_Property] PRIMARY KEY CLUSTERED  ([PropertyGuid]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_Name_ProductGuid] ON [catalog].[Property] ([Name], [ProductGuid]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [ix_Property_ProductGuid] ON [catalog].[Property] ([ProductGuid]) ON [PRIMARY]
GO
EXEC sp_addextendedproperty N'MS_Description', N'The property table ', 'SCHEMA', N'catalog', 'TABLE', N'Property', NULL, NULL
GO
EXEC sp_addextendedproperty N'MS_Description', N'Primary key', 'SCHEMA', N'catalog', 'TABLE', N'Property', 'COLUMN', N'PropertyGuid'
GO
