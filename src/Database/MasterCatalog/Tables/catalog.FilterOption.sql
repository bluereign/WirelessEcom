...
(
[FilterOptionId] [int] NOT NULL IDENTITY(1, 1),
...
[DynamicTag] [varchar] (8000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
---------------------------------------------------------------------------- 
-- Object Type : Trigger
-- Object Name : msdb.tr_logfilteroption
-- Description : Monitor all changes in the catalog.filteroption table
-- Author : Naomi Hall
-- Date : December 18th, 2012 -- Edited January 3, 2013
---------------------------------------------------------------------------- 

--The Trigger
CREATE TRIGGER [catalog].[tr_logfilteroption] ON [catalog].[FilterOption]
...
ALTER TABLE [catalog].[FilterOption] ADD CONSTRAINT [PK_FilterOption] PRIMARY KEY CLUSTERED  ([FilterOptionId]) ON [PRIMARY]
GO
