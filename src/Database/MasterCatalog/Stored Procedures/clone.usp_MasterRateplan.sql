...
CREATE PROCEDURE [clone].[usp_MasterRateplan] 
...
SELECT
	RateplanGuid, CarrierGuid, CarrierBillCode, @NewName, DEscription, Type, ContractTerm, IncludedLines,MaxLInes,MonthlyFee,AdditionalLineBillCode,AdditionalLineFee,PrimaryActivationFee,SecondaryActivationFee,IsShared
