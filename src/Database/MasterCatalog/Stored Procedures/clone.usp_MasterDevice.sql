...
CREATE PROCEDURE [clone].[usp_MasterDevice] 
...
INSERT INTO @TempDEV (DeviceGuid, CarrierGuid, ManufacturerGuid, UPC, Name)
SELECT
	DeviceGuid
	, CarrierGuid
	, ManufacturerGuid
	, @NewUPC
	, @NewName
FROM catalog.Device dev WHERE DeviceGuid = @OldGuid

UPDATE @TempDEV SET DeviceGuid = @NewGuid

INSERT INTO catalog.Device (DeviceGuid, CarrierGuid, ManufacturerGuid, UPC, Name)
SELECT
	DeviceGuid
	, CarrierGuid
	, ManufacturerGuid
