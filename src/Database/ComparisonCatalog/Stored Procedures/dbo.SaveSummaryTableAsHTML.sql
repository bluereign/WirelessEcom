...
CREATE PROCEDURE [dbo].[SaveSummaryTableAsHTML]
    @PCWrite varchar(1000) = NULL,
    @DBFetch varchar(4000),
    @DBWhere varchar(2000) = NULL,
    @DBThere varchar(2000) = NULL,
    @DBUltra bit = 1,
    @TableStyle varchar(1000) = 'border: 1px solid #4B0082; width: 700px; background-color: #F0E68C; border-radius: 0px; font-family: Arial,Helvetica,Verdana,sans-serif; font-size: 10px; color: #333;',
