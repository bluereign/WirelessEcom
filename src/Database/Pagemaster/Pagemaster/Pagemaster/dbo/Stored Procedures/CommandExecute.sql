...
BEGIN
  ...
  IF @LogToTable = 'Y'
  BEGIN
    INSERT INTO [logging].[CommandLog] (DatabaseName, SchemaName, ObjectName, ObjectType, IndexName, IndexType, StatisticsName, PartitionNumber, ExtendedInfo, CommandType, Command, StartTime)
