...
---------------------------------------------------------------------------- 
-- Object Type : Trigger
-- Object Name : msdb.tr_logproducttag
-- Description : Monitor all changes in the catalog.producttag table
-- Author : Naomi Hall
-- Date : December 18th, 2012 -- Edited January 3, 2013
---------------------------------------------------------------------------- 

--The Trigger
CREATE TRIGGER [catalog].[tr_logproducttag] ON [catalog].[producttag] FOR INSERT, UPDATE, DELETE
