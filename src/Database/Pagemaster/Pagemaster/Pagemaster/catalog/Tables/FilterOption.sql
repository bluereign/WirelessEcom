CREATE TABLE [catalog].[FilterOption] (
    ...
    [Active]         INT            NOT NULL,
    CONSTRAINT [PK_FilterOption] PRIMARY KEY CLUSTERED ([FilterOptionId] ASC)
);
...
--The Trigger
CREATE TRIGGER [catalog].[tr_logfilteroption] ON [catalog].[FilterOption] FOR INSERT, UPDATE, DELETE
