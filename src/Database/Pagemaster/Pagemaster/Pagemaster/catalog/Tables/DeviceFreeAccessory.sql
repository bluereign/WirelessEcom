...
---------------------------------------------------------------------------- 
-- Object Type : Trigger
-- Object Name : msdb.tr_logdevicefreeaccessory
-- Description : Monitor all changes in the catalog.devicefreeaccessory table
-- Author : Naomi Hall
-- Date : December 18th, 2012 -- Edited January 3, 2013
---------------------------------------------------------------------------- 

--The Trigger
CREATE TRIGGER [catalog].[tr_logdevicefreeaccessory] ON [catalog].[DeviceFreeAccessory] FOR INSERT, UPDATE, DELETE
...
SELECT @TableName = 'devicefreeaccessory'
