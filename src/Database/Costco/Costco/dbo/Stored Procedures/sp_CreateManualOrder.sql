CREATE proc sp_CreateManualOrder
...
SET @OrderDetailID_Device = (SELECT TOP 1 OrderDetailID FROM [salesorder].[OrderDetail]           
WHERE OrderID = @OrderID and OrderDetailType = 'd')

SET @DeviceSKU = (SELECT TOP 1 GersSku FROM [salesorder].[OrderDetail]           
WHERE OrderID = @OrderID and OrderDetailType = 'd')
...
SET @OrderDetailID_Kit = (SELECT TOP 1 OrderDetailID FROM [salesorder].[OrderDetail]           
WHERE OrderID = @OrderID and OrderDetailType = 'a')

SET @KitSKU = (SELECT TOP 1 GersSku FROM [salesorder].[OrderDetail]           
WHERE OrderID = @OrderID and OrderDetailType = 'a')
