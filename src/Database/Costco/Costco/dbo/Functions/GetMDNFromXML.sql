...
CREATE FUNCTION [dbo].[GetMDNFromXML] (@referenceNumber varchar(30))  
...
BEGIN 
	...
	data(/OAS:oasOrder/OAS:order/OAS:subOrder/OAS:authenticateSubscriberRequest/OAS:mdn)') AS VARCHAR(30))
END
return @mdn
END