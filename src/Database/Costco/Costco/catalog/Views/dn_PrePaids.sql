...
SELECT     
    ...
    , ISNULL((SELECT TOP 1 gp.Price FROM catalog.GersPrice AS gp WHERE p.GersSku = gp.GersSku AND gp.PriceGroupCode = 'NFR'),0) FinancedFullRetailPrice
    , ISNULL((SELECT TOP 1 gp.Price FROM catalog.GersPrice AS gp WHERE p.GersSku = gp.GersSku AND gp.PriceGroupCode = 'N12'),0) FinancedMonthlyPrice12
    , ISNULL((SELECT TOP 1 gp.Price FROM catalog.GersPrice AS gp WHERE p.GersSku = gp.GersSku AND gp.PriceGroupCode = 'N18'),0) FinancedMonthlyPrice18
    , ISNULL((SELECT TOP 1 gp.Price FROM catalog.GersPrice AS gp WHERE p.GersSku = gp.GersSku AND gp.PriceGroupCode = 'N24'),0) FinancedMonthlyPrice24                  
