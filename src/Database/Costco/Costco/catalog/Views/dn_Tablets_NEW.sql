...
CREATE VIEW [catalog].[dn_Tablets_NEW]
AS
/******************************************************************************************
*
*  Object: dn_Tablet
...
WITH onlineAvail( ProductGUID, Cnt )
  ...
  SELECT detail.DeviceGuid
       ...
       , '<span class="rebate-callout">%CarrierRebate1% %CarrierSkuRebate1%</span>' + detail.SummaryDescription AS summaryDescription
       , '<span class="rebate-callout">%CarrierRebate1% %CarrierRebate2% %CarrierSkuRebate1% %CarrierSkuRebate2%</span>' + detail.DetailDescription AS detailDescription
       , detail.MetaKeywords
