CREATE TABLE [dbo].[Users] (
    ...
    [wddxCart]                 TEXT           NULL,
    [IsOrderAssistanceOn]      BIT            CONSTRAINT [DF__Users__IsOrderAs__745AE5AF] DEFAULT ((0)) NOT NULL,
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Primary key', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Users', @level2type = N'COLUMN', @level2name = N'User_ID';
