...
SELECT @PKValue = a FROM @t
	...
	END
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Link to PaymentMethod table', @level0type = N'SCHEMA', @level0name = N'salesorder', @level1type = N'TABLE', @level1name = N'Payment', @level2type = N'COLUMN', @level2name = N'PaymentMethodId';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Link to Order table', @level0type = N'SCHEMA', @level0name = N'salesorder', @level1type = N'TABLE', @level1name = N'Payment', @level2type = N'COLUMN', @level2name = N'OrderId';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Primary key', @level0type = N'SCHEMA', @level0name = N'salesorder', @level1type = N'TABLE', @level1name = N'Payment', @level2type = N'COLUMN', @level2name = N'PaymentId';
