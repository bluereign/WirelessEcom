    ...
    <cfif IsDefined("form.action")>
        ...
        <cfelseif form.action eq "updateProperty">
            ...
            <cfif len(propertyId) gt 0>
                <cfset result = application.model.PropertyManager.updateProperty(propertyId, form.propertyMasterGuid, form.propertyValue, active, "Dev")> <!--- TODO: implement user --->
                <cfset message = "Property has been saved.">
            <cfelse>
                <cfset result = application.model.PropertyManager.insertProperty(productId, form.propertyMasterGuid, form.propertyValue, active, "Dev")> <!--- TODO: implement user --->
        ...
        <div>
            ...
            <div id="tabs">
                <ul>
                    ...
                    <!---<li><a href="#tabs-3" class="alert">Unasigned (<cfoutput>#strayProperties.RecordCount#</cfoutput>)</a></li>--->
                </ul>
                <div id="tabs-1">
