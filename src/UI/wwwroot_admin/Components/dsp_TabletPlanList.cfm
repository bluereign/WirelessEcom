...
<cfif IsDefined("form.action")>
	...
	<cfif form.action eq "updateDefaultTablet">	
		<cfset application.model.AdminTablet.updateDefaultDevicePlan( form.phoneGuid, form.isDefaultRateplanGuid ) />
	<cfelseif form.action eq "showAddAllActivePlans">
		<cfset local.tabletDetails = application.model.AdminTablet.getTablet(url.productGuid) />
		<cfset  application.view.AdminDevicePlan.getAddAllActivePlans(url.productguid,variables.channelId,local.tabletDetails.CarrierGuid) />
	<cfelseif form.action eq "showRemoveAllPlans">	
		<cfset local.tabletDetails = application.model.AdminTablet.getTablet(url.productGuid) />
		<cfset  application.view.AdminDevicePlan.getRemoveAllPlans(url.productguid,variables.channelId,local.tabletDetails.CarrierGuid) />
