$(function(){	
	var navSelector = "div#menu ul li";/** define the main navigation selector **/
	...
	$('.box-container').corners("5px bottom");
	 ...
	 $('ul.tab-menu li a').corners("5px top");
	 	 /** Instances of ckeditor for wysiwyg editors 
	 This is the Plan/PHones WYSIWYG and conflicts with CMS
	 **/
	...
	//$("#left-menu ul").accordion();/** side menu accordion - see jquery ui docs for help:  http://jqueryui.com/demos/  **/
