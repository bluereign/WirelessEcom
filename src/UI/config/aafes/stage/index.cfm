<cfscript>
	...
	request.config.SprintEndPoint =  "http://10.7.0.140/SprintCarrierInterface/SprintService.asmx?WSDL";
	...
	request.config.CarrierServiceBusTarget.Verizon = 'Verizon.Test';
