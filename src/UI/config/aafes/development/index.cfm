<cfscript>
	...
	request.config.docsRoot = "#request.config.webDocRoot#assets/common/docs/#request.config.pathDelim#";
	...
	//Customer service
	request.config.customerServiceNumber = "1 (866) 374-0804";
	request.config.customerServiceEmail = "emcsupport@wirelessadvocates.com";
	
	//Display configs
	request.config.CartReviewShippingDisplayName = 'TBD';
	...
	request.config.PlanDiscount.Sprint = 0;

	//MAC: Carrier Interface Local Endpoints
	request.config.TMobileEndPoint = "http://10.7.0.140/TMobileCarrierInterface/TMobileService.asmx?WSDL";
	request.config.SprintEndPoint =  "http://dev-ws.ecom.corp/api/sprintcarrierservice/aafes/sprintservice.asmx?WSDL";
	...
	//request.config.CarrierServiceBusTarget.Verizon = 'Verizon.Dev'; //'Verizon.Dev'
	request.config.CarrierServiceBusTarget.Verizon = 'Verizon.Test'; //'Verizon.Test'
	request.config.CarrierServiceBusTarget.ATT = 'ATT.Dev';
