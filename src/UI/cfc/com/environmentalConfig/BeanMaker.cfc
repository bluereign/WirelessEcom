<cfcomponent displayname="BeanMaker" hint="I create the bean for the application properties" output="true" extends="Object"  >
			...
			************************************************************************
			--->
		<cffunction name="init" returntype="BeanMaker" output="false" hint="I initialize the component" access="package">
			...
			********************************************************************************
			--->
		<cffunction name="createBean" output="true" access="package" returntype="struct" hint="I write the bean file to the specified path">
			...
			<cfargument name="setterAccess" type="string" required="false" default="public" />
			<cfscript>
...
<%/cfcomponent%></cfoutput>
				...
				<cfcatch type="any">
					<cfscript>
						eThrow("Error creating Bean file","environmentConfig.CreateBean");
		...
		<cffunction name="writeBeanToFile" output="false" access="package" returntype="struct" hint="I write the bean into a cfc">
			...
			<cftry>
				<cffile action="write" file="#expandPath( fixObjectPath(arguments.fullObjectPath) )#.cfc" output="#arguments.beanString#" />
				<cfcatch type="any">
					<cfscript>
			...
			********************************************************************************
			--->
		<cffunction name="indent" output="false" access="private" returntype="string" hint="inserts tab">
			<cfargument name="tabsQty" type="numeric" required="false" default="1" />
			<cfscript>
				var sTabs 	= '';
				var ixQty = 1;
			...
			********************************************************************************
			--->
		<cffunction name="fixBeanString" output="false" access="private" returntype="string" hint="I fix the bean string dymmy characters">
			...
			********************************************************************************
			--->
		<cffunction name="fixObjectPath" output="false" access="private" returntype="string" hint="I fix the bean string dymmy characters">
			<cfargument name="stringToFix" type="string" required="true"  />
			...
			********************************************************************************
			--->
		<cffunction name="getArgumentType" output="false" access="private" returntype="string" hint="I check the argument's type and return the type as a string">
