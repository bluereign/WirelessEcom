<cfcomponent displayname="ColdSpringDefinitionMaker" hint="Creates ColdSpring Definition File for the GlobalConfig Bean" output="false" >
		<!--- 	
		*************************************************************************
		init()
		************************************************************************
		--->																										
	<cffunction name="init" returntype="ColdSpringDefinitionMaker" output="No" hint="I initialize the component" access="package">
		...
		********************************************************************************
		--->
	<cffunction name="createColdSpringDefinition" output="true" access="package" returntype="xml" hint="I create the ColdSpring bean definition file for the GlobalConfig bean based on a structure of properties">
		<cfargument name="stProperties" type="struct" required="true"  />
		<cfargument name="objPathDotNotation" type="string" required="false" default="model.GlobalConfig" />
		<cfscript>	
				var sCSDefinition = "";
	...
	<cfoutput>
			...
			********************************************************************************
			--->
		<cffunction name="writeCSDefToFile" output="false" access="package" returntype="struct" hint="I write the bean into a cfc">
