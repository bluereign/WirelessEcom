...
<cfcomponent displayname="EnvironmentService" hint="Service for EnvironmentConfig" output="false" extends="Object" >
			...
			************************************************************************
			--->
	<cffunction name="init" returntype="EnvironmentService" output="No" hint="I initialize the component">
		...
		********************************************************************************
		--->
	<cffunction name="configureEnvironment" output="false" access="public" returntype="struct" hint="I configure an application's environment properties">
		...
		********************************************************************************
		--->
	<cffunction name="getEnvironmentProperties" output="false" access="private" returntype="struct" hint="I get the environment properties and return these in a structure">
		<cfargument name="sECDefinitionFilePath" type="string" required="true" />
		...
		<cfscript>
			...
			dump(e,true);
				eThrow(message:e.message,type:"environmentConfig.getEnvironmentProperties");
			}
		</cfscript>
	...
	<cffunction name="createFiles" output="false" access="package" returntype="struct" hint="I get the environment properties and return these in a structure">
		...
		********************************************************************************
		--->
	<cffunction name="setDefaultEcValues" output="false" access="private" returntype="void" hint="I work as a cfparam for the EC structure inside the properties">
		...
		********************************************************************************
		--->
	<cffunction name="createBeanFile" output="false" access="package" returntype="struct" hint="I create the bean based on a structure">
