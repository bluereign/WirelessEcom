...
<cfcomponent displayname="EnvironmentConfigAPI" hint="API to Environment Config. Use to leverage EC methods in your application" extends="Object" output="false">
		...
		************************************************************************
		--->																										
	<cffunction name="init" returntype="EnvironmentConfigAPI" output="No" hint="I initialize the component">
    	...
    	********************************************************************************
    	--->
    <cffunction name="createBeanFromStruct" output="false" access="public" returntype="struct" hint="Creates a Bean from a struct of properties">
