...
function swapDeviceImage(e){var i=$(".device-main img");i.attr("src",e)}function showHidePlanText(e){var i="Show Plan Details",t="Hide Plan Details";return e===t?i:t}function showHideDeviceText(e){var i="Show Device Details",t="Hide Device Details";return e===t?i:t}function toggleDiv(e,i){$(e).hide(),$(i).show()}function buildSlider(e){var i=$(e),t=i.children(".info"),n=i.find(".featured").index(),o=t.length,s={dots:!1,infinite:!1,initialSlide:(n>=0?n:1)-1,speed:300,slidesToShow:3,slidesToScroll:1,responsive:[{breakpoint:480,settings:{slidesToShow:1}}]};3>o&&(s.arrows=!1),$(e).slick(s)}$(document).ready(function(){var e=$(".carousel"),i=$("#new-customer1"),t=$("#new-customer2"),n=$(".device-thumb"),o=$(".accessories .product");$filterableProducts=$(".tab-pane .product"),e.each(function(e,i){buildSlider(i)}),$(".plan-details").on("click",function(){var e=$(this);$(this).text(showHidePlanText(e.text()))}),$(".device-details").on("click",function(){var e=$(this);$(this).text(showHideDeviceText(e.text()))}),t.hide(),i.on("click",".btn",function(e){e.preventDefault(),toggleDiv("#new-customer1","#new-customer2")}),$(".nav-tabs a").on("click",function(e){var i=$(this).parent().attr("class"),t=$filterableProducts.parent();$filterableProducts&&(t.hide(),"all"===i?t.show():i&&$("."+i).parent().show())}),$(".plans #choose-a-new-plan").on("click",function(i){i.preventDefault(),$("#plan-options").show(),$(".plan-chooser .plan-seperator").hide(),$("#choose-a-new-plan").hide(),e.each(function(i,t){e[i].slick.setPosition()})}),$(".nav-tabs").on("shown.bs.tab",function(i,t){e.each(function(i,t){e[i].slick.setPosition()})}),o.on("mouseover",function(){$(this).addClass("hover")}).on("mouseout",function(){$(this).removeClass("hover")}).find(".info-wrap").on("mouseover",function(e){e.stopPropagation()}),n.on("click",function(e){e.preventDefault();var i=$(this),t=i.children("img").data("full-src");n.removeClass("active"),i.addClass("active"),swapDeviceImage(t)})});
