...
<cfscript>
	...
	function renderErrorByField( fieldname )
	{
		...
		{
			result = '<p id="error-#fieldname#" class="error">' & failureCollection[ arguments.fieldname ] & '</p>';
		}
		return result;
	}
</cfscript>
