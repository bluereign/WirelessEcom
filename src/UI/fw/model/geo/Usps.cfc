...
UPDATED for CF8 by wil@cfwebtools.com
...
<cfcomponent name="USPS" displayname="USPS CFC" output="false" hint="This is a ColdFusion CFC used to connect to the USPS API.">
<!---	<cfproperty name="isProduction" type="boolean">
	...
	<cffunction name="AddressValidate" access="public" returntype="string" output="false" hint="Corrects errors in street addresses, including abbreviations and missing information, and supplies ZIP Codes and ZIP Codes + 4.">
		<cfargument name="FirmName" type="String" required="false" default="">
		<cfargument name="Address1" type="String" required="false" default="">
		<cfargument name="Address2" type="String" required="true">
		...
		<cfset local.requestResponse = processRequest(local.api, local.xml)>
		<cfreturn parseXml(local.requestResponse)>
	</cffunction>
	...
	<!--- setters and getters --->
	<cffunction name="getURLTEST" access="public" returntype="any" output="false">
		<cfreturn variables.instance.URLTEST />
	</cffunction>
	<cffunction name="setURLTEST" access="public" returntype="void" output="false">
		<cfargument name="URLTEST" type="any" required="true" />
		<cfset variables.instance.URLTEST = arguments.URLTEST>
	</cffunction>

	<cffunction name="getURLTESTSECURE" access="public" returntype="any" output="false">
		<cfreturn variables.instance.URLTESTSECURE />
	</cffunction>
	<cffunction name="setURLTESTSECURE" access="public" returntype="void" output="false">
		<cfargument name="URLTESTSECURE" type="any" required="true" />
		<cfset variables.instance.URLTESTSECURE = arguments.URLTESTSECURE>
	</cffunction>

	<cffunction name="getURLPROD" access="public" returntype="any" output="false">
		<cfreturn variables.instance.URLPROD />
	</cffunction>
	<cffunction name="setURLPROD" access="public" returntype="void" output="false">
		<cfargument name="URLPROD" type="any" required="true" />
		<cfset variables.instance.URLPROD = arguments.URLPROD>
	</cffunction>

	<cffunction name="getURLPRODSECURE" access="public" returntype="any" output="false">
		<cfreturn variables.instance.URLPRODSECURE />
	</cffunction>
	<cffunction name="setURLPRODSECURE" access="public" returntype="void" output="false">
		<cfargument name="URLPRODSECURE" type="any" required="true" />
		<cfset variables.instance.URLPRODSECURE = arguments.URLPRODSECURE>
	</cffunction>

	<cffunction name="getUrl" access="public" returntype="any" output="false">
	...
	<cffunction name="getIsProduction" access="public" returntype="any" output="false">
		<cfreturn variables.instance.sProduction />
	</cffunction>
	<cffunction name="setIsProduction" access="public" returntype="void" output="false">
		<cfargument name="sProduction" type="any" required="true" />
		<cfset variables.instance.sProduction = arguments.sProduction>
	</cffunction>

	<cffunction name="getIsSecure" access="public" returntype="any" output="false">
		<cfreturn variables.instance.isSecure />
	</cffunction>
	<cffunction name="setIsSecure" access="public" returntype="void" output="false">
		<cfargument name="isSecure" type="any" required="true" />
		<cfset variables.instance.isSecure = arguments.isSecure>
	</cffunction>

	<cffunction name="getUspsUserID" access="public" returntype="any" output="false">
		<cfreturn variables.instance.uspsUserID />
	</cffunction>
	<cffunction name="setUspsUserID" access="public" returntype="void" output="false">
		<cfargument name="uspsUserID" type="any" required="true" />
		<cfset variables.instance.uspsUserID = arguments.uspsUserID>
	</cffunction>

	<cffunction name="parseXml" access="public" output="false" returntype="string" hint="">
    	<cfargument name="xmlPacket" type="xml" required="true" >
		<cfset var responseCode = ''>
		<cfscript>
			if(isXml(xmlPacket)) {
				xPathValue = XmlSearch(xmlPacket,"/AddressValidateResponse/Address/Error");
				if(arrayLen(xPathValue)){
					// there was an error
					responseCode = "USPS002";
				} else {
					responseCode = "USPS003";
				}
			}
			return responseCode;
        </cfscript>
