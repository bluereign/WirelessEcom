    ...
    <section class="content">
      ...
      <form id="formCheckoutReview" action="#event.buildLink('/CheckoutDB/processOrderReview')#" method="post">
        <input type="hidden" id="carrierID" value="#session.cart.getCarrierId()#">
  			...
  			<input type="hidden" id="costcoAttTermsURL" value="#assetPaths.channel#docs/customerletters/att/ATT_Next_Customer_Letter_11_20_15_API.pdf">
            ...
            <div class="table-wrap">
              <table class="table table-responsive">
                <tr>
                  ...
                  <td></td>
                  <td><cfif prc.upgradeFee>#dollarFormat(arrayLen(prc.cartLines)*prc.upgradeFee)#<cfelse>$18.00</cfif></td>
                </tr>
              </table> 
            </div>
          </div>
