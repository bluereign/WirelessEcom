...
<div class="row">
	<div class="col-md-4">
		...
		<a href="#prc.productImages[1].imageHref#" id="prodDetailImgHref" data-lightbox="device-image-set" title="#prc.productImages[1].imageAlt#">
			<img id="prodDetailImg" src="#prc.productImages[1].imagesrc#" border="0" width="280" alt="#prc.productImages[1].imageAlt#" title="Click to Zoom" />
		</a>
		</cfif>
	</div>
	<div class="col-md-8">
		...
		<h2 class="productTitle">#prc.productData.summaryTitle#</h2>
		<div style="clear:both;"></div>
		#application.view.product.ReplaceRebate( '<span class="rebate-callout">%CarrierRebate1% %CarrierRebate2% %CarrierSkuRebate1% %CarrierSkuRebate2%</span>', prc.productData.carrierId, prc.productData.gersSku)# <br />

		<div class="row" style="text-align:center;">
	
		<div class="col-md-12" id="priceblock" style="display:inline-block;float:none;text-align:left;">
			<div id="priceblock-tmofinance">
					<button class="priceBlockHeader" id="priceBlockHeader-simplechoice" data-activation-type="finance">
						<div style="float:left;">
							<cfif prc.productData.monthlyPayment gt 0.00> 
								Price Today
							<cfelse>
								Full Retail Price
							</cfif>
						...
						<div style="float:right;">
							<cfif prc.productData.monthlyPayment gt 0.00> 
								#dollarFormat(prc.productData.downpayment)# down
							<cfelse>
								#dollarFormat(prc.productData.price_new)#
							</cfif>
						</div>
					</button>
					<div  id="price-slide-simplechoice">
						<table class="table">
							<cfif prc.productData.monthlyPayment gt 0.00>
								<tr class="border-none"> 
									<td>Device Payment (monthly)</td>
									<td class="alignright">#dollarFormat(prc.productData.monthlyPayment)# x 24 mos</td>
								</tr>
							</cfif>
							<tr class="border-none">
								<td>Full Retail Price</td>
								<td class="alignright"><!---(<strike>#dollarFormat(prc.productData.price_retail)#</strike>) &nbsp;&nbsp; --->#dollarFormat(prc.productData.price_new)#</td>
							</tr>
							<cfif prc.productData.monthlyPayment gt 0.00> 
								<tr class="border-none">
									<td colspan="2">IF YOU FINANCE YOUR DEVICE AND CANCEL WIRELESS SERVICE, REMAINING BALANCE ON PHONE BECOMES DUE.</td>
								</tr>
							</cfif>
						</table>
					</div>
					...
					<cfif prc.productData.monthlyPayment gt 0.00>
						...
						<p>
							For well-qualified buyers. 0% APR, O.A.C. Qualifying service required.
						</p>					
						</div>
					</cfif>
					<hr />
...
<div class="row" >
	<div class="col-md-6" >
		...
		<div id="availability-container-nonfinance">
			<em>&raquo; Available: 
	...
	<div class="col-md-6">
		<div id="addtocart-finance" class="pull-right">
			<a class="ActionButton learnMoreBtn" data-toggle="modal" data-target="##tmoredirect" href="##"><span>Continue</span></a>
		</div>
	</div>
</div>
...
--->
	...
	<div class="col-md-8">
		...
		<p><super>**</super>Contents of bonus pack vary by device. Also available in warehouse.<br/>
		<super>***</super>Accessory Bonus Pack and Costco Cash Card will ship separatly from the wireless device.</p>
Please note the free Accessory Bundle Pack and Costco Cash Card will ship separatly from the wireless device. For more information on how T-Mobile collects, uses, discloses, and store customer information, please visit T-Mobile's privacy policy. 
	</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <cfif findNoCase( 'costco', prc.channelConfig.getDisplayName() )>
        	<p>By clicking "Approve and proceed" you will now be transferred to T-Mobile's website. If you approve and proceed, T-Mobile will share your information (including your name, address, e-mail address, phone number, traffic and order data, device type, rate plan and features, and return and exchange details) with Wireless Advocates (Costco's designated agent) upon the completion of your transaction. Your customer information will be shared for purposes of Wireless Advocates' accounting and reporting of your T-Mobile transaction and to permit Wireless Advocates to provide you with customer service - including sending you your free Accessory Bundle Pack and Costco Cash Card. Please note the free Accessory Bundle Pack and Costco Cash Card will ship separately from the wireless device. For more information on how T-Mobile collects, uses, discloses, and stores customer information, please visit T-Mobile's privacy policy.
 
			<p>PLEASE NOTE: At this time, Costco cannot process orders to a PO Box address.  If you receive the billing statement for your T-Mobile account at a PO Box address, you will have to purchase your device through T-Mobile directly.<p>
 
			<p>Please click 'Approve and proceed' to continue.</p>
        <cfelse>
        	<p>You will now be transferred to T-Mobile's website. If you approve and proceed, T-Mobile will share your information (including your name, address, e-mail address, phone number, traffic and order data, device type, rate plan and features, and return and exchange details) with Wireless Advocates upon the completion of your transaction. Your customer information will be shared for purposes of Wireless Advocates' accounting and reporting of your T-Mobile transaction and to permit Wireless Advocates to provide you with customer service - including sending you any Wireless Advocates benefits for which you are eligible based on this transaction. For more information on how T-Mobile collects, uses, discloses, and stores customer information, please visit T-Mobile's privacy policy.</p>

        	<p>Please click 'Approve and proceed' to approve and proceed or click 'Cancel' to exit this process.</p>
        </cfif>
      </div>
