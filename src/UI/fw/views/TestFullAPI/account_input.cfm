...
<tr><th align="right">Phone Number:</th><td><input type="text" name="SubscriberNumber" value="9499406615"/></td></tr>
<tr><th align="right">Zip Code:</th><td><input type="text" name="ZipCode" value="98008"/></td></tr>
<tr><th align="right">Security Id:</th><td><input type="text" name="SecurityId" value="6600"/></td></tr>
