...
<tr><th align="right">Phone Number:</th><td><input type="text" name="SubscriberNumber" value="2107909315"/></td></tr>
...
<tr><th align="right">Passcode:</th><td><input type="text" name="Passcode" value="SDDVRP"/></td></tr>
