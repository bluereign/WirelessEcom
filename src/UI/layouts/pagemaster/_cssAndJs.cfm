...
<cfoutput>
	...
	<link rel="stylesheet" media="#request.p.media#" type="text/css" href="#assetPaths.channel#styles/main.css?v=2.0.8" />
	<link rel="stylesheet" media="#request.p.media#" type="text/css" href="#assetPaths.channel#styles/navigation.css?v=1.0.0" /> <!-- remove once merged with existing Main and dropdown CSS files -->
	<link rel="stylesheet" media="#request.p.media#" type="text/css" href="#assetPaths.channel#styles/styles.css?v=1.0.0" /> <!-- remove once merged with existing Main and dropdown CSS files -->
	<link rel="stylesheet" media="#request.p.media#" type="text/css" href="#assetPaths.common#styles/cartDialog.css?v=1.0.5" />
	<link rel="stylesheet" media="#request.p.media#" type="text/css" href="#assetPaths.channel#styles/cartDialog.css?v=1.0.0" />
	<link rel="stylesheet" media="#request.p.media#" type="text/css" href="#assetPaths.common#styles/verticalTabs.css?v=1.0.0" />
	...
	<cfif request.p.go is 'shop'>
		<cfif request.p.do contains 'browsePhones' or request.p.do contains 'browseDataCards' or request.p.do contains 'browsePrePaids'>
			<link rel="stylesheet" media="#request.p.media#" type="text/css" title="Exchange Mobile Center" href="#assetPaths.common#styles/workflowController.css" />
	...
	<cfif NOT bJavascriptIncluded>
		...
		<script type="text/javascript" src="#assetPaths.common#scripts/lightbox/js/lightbox-2.6.min.js"></script>
		<script type="text/javascript" src="#assetPaths.common#scripts/analytics.js?v=1.0.1"></script>
