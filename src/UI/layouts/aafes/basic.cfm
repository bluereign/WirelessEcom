...
<cfparam name="request.title" default="AAFES Wireless - Big Savings on Cell Phones - Offering Plans from Verizon Wireless, AT&T, T-Mobile, and Sprint." type="string" />
<cfparam name="request.MetaDescription" default="AAFES Wireless offers big savings on phones from Verizon, AT&T, T-Mobile, and Sprint. In additional to great prices, AAFES Wireless offers Free New Activation, Free shipping, and Free Accessories with the phone purchase." type="string" />
...
<cfoutput>
	...
	<html xmlns="http://www.w3.org/1999/xhtml">
		<head>
			...
			<link rel="stylesheet" type="text/css" href="#assetPaths.channel#styles/main.css?v=2.0.5" />
