...
<head>
	...
	<style type="text/css">
		...
		*/
		...
		Simple fix with little effect on other styling. NOTE: It is also common to use two breaks instead of the paragraph tag but I think this way is cleaner and 
		more semantic. NOTE: This example recommends 1em. More info on setting web defaults: http://www.w3.org/TR/CSS21/sample.html or http://meiert.com/en/blog/20070922/user-agent-style-sheets/

		Bring inline: Yes.
		**/
		/*p {margin: 1em 0;}*/

		/** Hotmail header color reset: Hotmail replaces your header color styles with a green color on H2, H3, H4, H5, and H6 tags. In this example, 
		the color is reset to black for a non-linked header, blue for a linked header, red for an active header (limited support), and purple for a 
		visited header (limited support).  Replace with your choice of color. The !important is really what is overriding Hotmail's styling. Hotmail 
		...
		*/
		@media only screen and (max-device-width: 480px) {
			...
			/* A nice and clean way to target phone numbers you want clickable and avoid a mobile phone from linking other numbers that look like, but are not phone numbers.  
			Use these two blocks of code to "unstyle" any numbers that may be linked.  The second block gives you a class to apply with a span tag to the numbers you would like linked and styled.
			...
			<tr>
				<cfoutput>
					...
					<td width="50%" valign="top">
						<a href="http://membershipwireless.com/" style="text-decoration: none;">
							<img src="http://#domain##assetPaths.channel#images/WirelessAdvocates_logosm.gif" 
								alt="Wireless Advocates" width="143" height="38" />
						</a>
					</td>
					<td width="50%" valign="top" align="right">
						<a href="http://www.costco.com/" style="text-decoration: none;">
							<img src="http://#domain##assetPaths.channel#images/costco_logosm.gif" 
