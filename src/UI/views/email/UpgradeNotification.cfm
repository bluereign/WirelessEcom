		...
		<tr>
			<td width="100% "valign="top" align="left">
            	<a href="#upgradeURL#" style="cursor:pointer;color:##390;margin-right:20px;text-decoration:none;">	
					<img src="http://#domain##assetPaths.common#/images/email/shop.png" width="242" height="315" alt="Shop for my Upgrades" />
                </a>
          		<a href="http://#domain#/index.cfm/go/shop/do/browseAccessories/" style="cursor:pointer">
           	  		<img src="http://#domain##assetPaths.common#/images/email/accessories.png" width="240" height="314" alt="Shop Accessories" />
                </a>
            </td>
		</tr>
		<tr>
