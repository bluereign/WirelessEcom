...
<cfset upgradeURL = "http://#request.config.emailTemplateDomain#/index.cfm/go/shop/do/browsePhones/phoneFilter.submit/1/filter.filterOptions/" />
...
<cfsavecontent variable="templateMessage">
	...
	<cfoutput>
		...
		<tr>
			<td width="100% "valign="top" align="left">
            	<a href="#upgradeURL#" style="cursor:pointer;color:##390;margin-right:20px;text-decoration:none;">	
          		...
          		<a href="http://#request.config.emailTemplateDomain#/index.cfm/go/shop/do/browseAccessories/" style="cursor:pointer">
		...
		<tr>
			<td width="100%" valign="top" colspan="2">
	        	<p style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:##333; margin-bottom:0px; margin-top:0px;">
					Costco.com and Wireless Advocates offer great upgrade prices you would expect from Costco. Click 
					<a href="#upgradeURL#">
	               		Shop for my Upgrade
					</a> to get started.
				</p>
	...
	<!--- template foot --->
	<cfinclude template="wa_costcoUpgradeFoot.cfm" />
</cfsavecontent>
