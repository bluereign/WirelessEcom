			...
			<tr>
				<td colspan="2">
					...
					<div>
						...
						<p style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:##333333;">
							Thank you for your recent Wireless Advocates #application.wirebox.getInstance("ChannelConfig").getPresaleVerbiage()# order with Exchangemobilecenter.com ! 
					...
					<div>
						...
						<p style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:##333;">
							Thank you for shopping with ExchangeMobileCenter.com.
						</p>   
						<p style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:##333;">
							AAFESMobile.com<br />
