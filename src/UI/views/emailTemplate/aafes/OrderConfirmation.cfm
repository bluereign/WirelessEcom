		...
		<tr>
			<td colspan="2">
				...
				<div>
					...
					<p style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:##333;">
						Please do not reply to this email. If you have questions regarding your order please contact customer 
					...
					<p style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:##333;">
						...
						<a href="http://#domain#/index.cfm/go/shop/do/browseAccessories/">CLICK HERE TO BEGIN SHOPPING</a>
					</p>  
				</div>  
		<p>   
