<!--- AAFES Samsung Galaxy S6 Landing Page --->
...
<cfoutput>
        ...
        <div id="samsung-promo">
            <header class="fixed">
                ...
                <a class="button" href="/index.cfm/go/shop/do/browsePhones/phoneFilter.submit/1/filter.filterOptions/0,476,477/index?utm_source=aafesmobile&utm_medium=landing_page&utm_campaign=ALL_S6-S6Edge_3-27-15">Pre-Order Now</a>
            ...
            <div class="panel white" id="carrier">
                ...
                <div class="right">
                    <h1>Get an exclusive in person introduction today.</h1>
                    <p>To see and hold this indredible device visit an Exchange Mobile kiosk, otherwise Pre-Order it Now.</p>
