...
<p>
	If you need help with APO/FPO shipping, please contact Customer Care at <cfoutput>#channelConfig.getCustomerCarePhone()#</cfoutput> 
	(toll-free) or email us at <a href="mailto:emcsupport@wirelessadvocates.com">
	emcsupport@wirelessadvocates.com</a>
</p>
