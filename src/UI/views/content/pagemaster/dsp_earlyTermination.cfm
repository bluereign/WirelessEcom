...
<cfswitch expression="#url.carrier#">
	...
	<cfcase value="verizon">
		<h1>Verizon  Early Termination</h1>
		<p>You can try out our service for 14 days. Verizon Wireless gives all customers a 14 day (from date of purchase) trial period to try out the phone and Verizon service without incurring an early termination fee. If the service is canceled after the 14 day trial period, Verizon will charge the subscriber an early termination fee per line of service as follows: </p>
		<p>
		...
		<p>Standard Handset: $175 Early Termination Fee (Fee will be reduced by $5 for each full month completed toward the minimum term of the contract) Note: Visit www.verizonwireless.com/advanceddevices for details on Verizon handset types. </p>
	</cfcase>	
</cfswitch>