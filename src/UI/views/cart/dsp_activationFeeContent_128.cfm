<!--- T-Mobile Activation Fee Content Include --->
...
<cfset local.activationFee = local.carrierObj.getActivationFee( 128 )>
...
<cfoutput>
	...
	<p>
		...
		agreements. The $35.00 service activation credit appears on your bill 2-3 months after initial service is
		established. 
	</p>
</cfoutput>