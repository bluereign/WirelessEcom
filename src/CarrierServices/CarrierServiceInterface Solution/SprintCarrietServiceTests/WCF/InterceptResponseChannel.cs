...
namespace SprintCarrierServiceTests.WCF
{
    ...
    internal class InterceptResponseChannel : IRequestChannel
    {
        ...
        public Message Request(Message message, TimeSpan timeout)
        {
            ...
            // ==================================================================================
            Trace.WriteLine("InterceptResponseChannel.Request ==> " + response);

            // need to create a copy first
            buffer = response.CreateBufferedCopy(int.MaxValue);
            ...
            // create message
            var strippedMessage = Message.CreateMessage(reader, int.MaxValue, response.Version);
