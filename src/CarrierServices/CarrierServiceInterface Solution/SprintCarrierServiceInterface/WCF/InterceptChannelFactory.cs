// --------------------------------------------------------------------------------------------------------------------
// <copyright file="InterceptChannelFactory.cs" company="">
//   
// </copyright>
// <summary>
...
namespace SprintCSI.WCF
{
    ...
    /// <summary>The intercept channel factory.</summary>
    /// <typeparam name="TChannel"></typeparam>
    internal class InterceptChannelFactory<TChannel> : ChannelFactoryBase<TChannel>
    {
        #region Fields
        ...
        protected override TChannel OnCreateChannel(EndpointAddress to, Uri via)
        {
            ...
            {
                var cachereqCnl = new InterceptResponseChannel((IRequestChannel)innerchannel);
