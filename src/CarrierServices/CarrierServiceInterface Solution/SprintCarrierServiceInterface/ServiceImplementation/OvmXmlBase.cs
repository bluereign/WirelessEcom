// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OvmXmlBase.cs" company="">
//   
// </copyright>
// <summary>
//   The base impl.
...
namespace SprintCSI.ServiceImplementation
{
    ...
    /// <summary>The ovm xml base.</summary>
    /// <typeparam name="TWaRequest"></typeparam>
    /// <typeparam name="TWaResponse"></typeparam>
    public abstract class OvmXmlBase<TWaRequest, TWaResponse>
    {
        #region Constants
        ...
        /// <summary>Initializes a new instance of the <see cref="OvmXmlBase{TWaRequest,TWaResponse}" /> class.</summary>
        protected OvmXmlBase()
        {
        ...
        public XmlHelper RequestXmlHelper { get; set; }
        ...
        /// <param name="req">The req.</param>
        public virtual void MapRequest(TWaRequest req)
        {
            // Does nothing if the concrete class does not implement this method
        ...
        private TWaResponse WaResponse(TWaRequest req, string refNum)
        {
            ...
            try
            {
                ...
                requestXml = this.RequestXmlHelper.GenerateXml();
