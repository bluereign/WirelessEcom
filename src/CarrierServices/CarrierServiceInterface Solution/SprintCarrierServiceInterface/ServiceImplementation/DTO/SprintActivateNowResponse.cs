// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SprintActivateNowResponse.cs" company="">
//   
// </copyright>
// <summary>
...
namespace SprintCSI.ServiceImplementation.DTO
{
    ...
    public class SprintActivateNowResponse : CarrierResponse, ISprintErrorInfo
    {
        #region Constructors and Destructors

        /// <summary>Initializes a new instance of the <see cref="SprintActivateNowResponse"/> class.</summary>
        ...
        public SprintActivateNowResponse(
            int errorCode, 
