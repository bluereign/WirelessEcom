...
namespace SprintCSI.ServiceImplementation.DTO
{
    ...
    public class SprintPlansAndOptionsValidationResponse : AddressValidationResponse, ISprintErrorInfo
    {
        #region Constructors and Destructors

        /// <summary>Initializes a new instance of the <see cref="SprintPlansAndOptionsValidationResponse"/> class.</summary>
        ...
        public SprintPlansAndOptionsValidationResponse(
            int errorCode, 
