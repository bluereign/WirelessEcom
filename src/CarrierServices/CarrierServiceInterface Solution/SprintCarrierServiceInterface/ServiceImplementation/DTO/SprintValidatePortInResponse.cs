// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SprintValidatePortInResponse.cs" company="">
//   
// </copyright>
// <summary>
...
namespace SprintCSI.ServiceImplementation.DTO
{
    ...
    public class SprintValidatePortInResponse : ValidatePortInResponse, ISprintErrorInfo
    {
        #region Constructors and Destructors

        /// <summary>Initializes a new instance of the <see cref="SprintValidatePortInResponse"/> class.</summary>
        ...
        public SprintValidatePortInResponse(
            int errorCode, 
            int subErrorCode, 
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="SprintValidatePortInResponse" /> class. Prevents a default
        ///     instance of the <see cref="SprintValidatePortInResponse" /> class from being created.
        /// </summary>
        public SprintValidatePortInResponse()
        {
        }
