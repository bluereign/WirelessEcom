/****** Object:  UserDefinedFunction [catalog].[GetUpgradeCommissionSku]    Script Date: 02/03/2012 12:03:31 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	ELSE IF (@CarrierName='Verizon Wireless')
		...
		BEGIN
			IF (@MonthlyFee <= 49.98) SET @GersSku = 'CWS2VZUP2'; -- $0.01 - $49.98 
			ELSE IF (@MonthlyFee <= 89.98) SET @GersSku = 'CWS2VZUP3'; -- $49.99 - $89.98 
			ELSE SET @GersSku = 'CWS2VZUP4'; -- $89.99 and up 
		END
