    ...
    class Program
    {
       ...
       static string GetInputDateString(string[] args)
       {
        ...
        static void Main(string[] args)
        {
            ...
            VarCharFeed.Dimensions = "ga:browser,ga:browserVersion,ga:operatingSystem,ga:operatingSystemVersion";
            VarCharFeed.Metrics = "ga:visits,ga:transactions";
            ...
            string sql = "DELETE FROM dashboard.BrowserOSGeneral WHERE RunDate = '" + date + "'";
            ...
            //foreach (DataEntry pvEntry in feed.Entries)
            {
                ...
                string browser = pvEntry.Dimensions[0].Value.Substring(0);
                string browserversion = pvEntry.Dimensions[1].Value.Substring(0);
                string operatingsystem = pvEntry.Dimensions[2].Value.Substring(0);
                string operatingsystemversion = pvEntry.Dimensions[3].Value.Substring(0);
                string visits = pvEntry.Metrics[0].Value;
                string transactions = pvEntry.Metrics[1].Value;
            ...
            string sql2 = "INSERT INTO dashboard.BrowserOSGeneral " +
                    " (RunDate, Browser, BrowserVersion, OperatingSystem, OperatingSystemVersion, Visits, Transactions) " +
                    //" (RunDate, SearchTerm, UniqueSearches) " +
                    " VALUES ('" + date + "','" + browser + "','" + browserversion + "','" + operatingsystem + "','" + operatingsystemversion + "','" + visits + "','" + transactions + "')";
