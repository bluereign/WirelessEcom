    ...
    class Program
    {
       ...
       static string GetInputDateString(string[] args)
       {
        ...
        static void Main(string[] args)
        {
            ...
            VarCharFeed.Ids = "ga:73885291";
            VarCharFeed.Dimensions = "ga:campaign,ga:source,ga:medium,ga:referralPath";
            VarCharFeed.Metrics = "ga:uniquePageviews,ga:transactions";
            //VarCharFeed.Metrics = "ga:searchUniques";
            VarCharFeed.Sort = "-ga:campaign";
            ...
            string sql = "DELETE FROM dashboard.Campaign WHERE RunDate = '" + date + "'";
            ...
            //foreach (DataEntry pvEntry in feed.Entries)
            {
                ...
                string campaign = pvEntry.Dimensions[0].Value.Substring(0);
                string source = pvEntry.Dimensions[1].Value.Substring(0);
                string medium = pvEntry.Dimensions[2].Value.Substring(0);
                string referral = pvEntry.Dimensions[3].Value.Substring(0);
                string traffic = pvEntry.Metrics[0].Value;
                string bought = pvEntry.Metrics[1].Value;
            ...
            string sql2 = "INSERT INTO dashboard.Campaign " +
                    " (RunDate, Campaign, Source, Medium, Referral, Traffic, Transactions) " +
                    //" (RunDate, SearchTerm, UniqueSearches) " +
                    " VALUES ('" + date + "','" + campaign + "','" + source + "','" + medium + "','" + referral + "','" + traffic + "','" + bought + "')";
