    ...
    public class nData
    {
        ...
        private int GetCommitCheck(string StartDate, string EndDate)
        {
            ...
            var dataQuery = new DataQuery(dataFeedUrl)
            {
                ...
                Filters = "ga:pagePath=~index.cfm/go/checkout/do/wirelessAccountForm/bSoftReservationSuccess/1,ga:pagePath=~index.cfm/go/checkout/do/lnpRequest/bSoftReservationSuccess/1,ga:pagePath=~index.cfm/go/checkout/do/billShip/bSoftReservationSuccess/1,ga:pagePath=~index.cfm/go/checkout/do/wirelessAccountForm/bSoftReservationSuccess/1,ga:pagePath=~index.cfm/go/checkout/do/billShip/bSoftReservationSuccess/1",
                //Segment = "gaid::573625486",
                GAStartDate = startDate.ToString("yyyy-MM-dd"),
                GAEndDate = endDate.ToString("yyyy-MM-dd"),
                NumberToRetrieve = 10000
        ...
        private int GetBillShip(string StartDate, string EndDate)
        {
            ...
            var dataQuery = new DataQuery(dataFeedUrl)
            {
                ...
                Metrics = "ga:uniquePageviews",
                Sort = "ga:uniquePageviews",
                Filters = "ga:pagePath=~index.cfm/go/checkout/do/billShip",
                //Segment = "gaid::573625486",
                GAStartDate = startDate.ToString("yyyy-MM-dd"),
                GAEndDate = endDate.ToString("yyyy-MM-dd"),
                NumberToRetrieve = 10000
        ...
        private int GetAddtoCart(string StartDate, string EndDate)
        {
            ...
            var dataQuery = new DataQuery(dataFeedUrl)
            {
                ...
                Metrics = "ga:uniquePageviews",
                Sort = "ga:uniquePageviews",
                Filters = "ga:pagePath=~cart/do/view/index.cfm,ga:pagePath=~cart/do/view/",
                //Segment = "gaid::573625486",
                GAStartDate = startDate.ToString("yyyy-MM-dd"),
                GAEndDate = endDate.ToString("yyyy-MM-dd"),
                NumberToRetrieve = 10000
        ...
        private int GetConfirmOrder(string StartDate, string EndDate)
        {
            ...
            var dataQuery = new DataQuery(dataFeedUrl)
            {
                ...
                Metrics = "ga:uniquePageviews",
                Sort = "ga:uniquePageviews",
                Filters = "ga:pagePath=~index.cfm/go/checkout/do/orderConfirmation",
                //Segment = "gaid::573625486",
                GAStartDate = startDate.ToString("yyyy-MM-dd"),
                GAEndDate = endDate.ToString("yyyy-MM-dd"),
                NumberToRetrieve = 10000
        ...
        private int GetCarrierTerms(string StartDate, string EndDate)
        {
            ...
            var dataQuery = new DataQuery(dataFeedUrl)
            {
                ...
                Metrics = "ga:uniquePageviews",
                Sort = "ga:uniquePageviews",
                Filters = "ga:pagePath=~index.cfm/go/checkout/do/carrierTerms",
                //Segment = "gaid::573625486",
                GAStartDate = startDate.ToString("yyyy-MM-dd"),
                GAEndDate = endDate.ToString("yyyy-MM-dd"),
                NumberToRetrieve = 10000
        ...
        private int GetCovCheck(string StartDate, string EndDate)
        {
            ...
            var dataQuery = new DataQuery(dataFeedUrl)
            {
                ...
                Metrics = "ga:uniquePageviews",
                Sort = "ga:uniquePageviews",
                Filters = "ga:pagePath=~index.cfm/go/checkout/do/coverageCheck",
                //Segment = "gaid::573625486",
                GAStartDate = startDate.ToString("yyyy-MM-dd"),
                GAEndDate = endDate.ToString("yyyy-MM-dd"),
                NumberToRetrieve = 10000
        ...
        private int GetTermsCond(string StartDate, string EndDate)
        {
            ...
            var dataQuery = new DataQuery(dataFeedUrl)
            {
                ...
                Metrics = "ga:uniquePageviews",
                Sort = "ga:uniquePageviews",
                Filters = "ga:pagePath=~index.cfm/go/checkout/do/termsConditions",
                //Segment = "gaid::573625486",
                GAStartDate = startDate.ToString("yyyy-MM-dd"),
                GAEndDate = endDate.ToString("yyyy-MM-dd"),
                NumberToRetrieve = 10000
        ...
        private int GetLetter(string StartDate, string EndDate)
        {
            ...
            var dataQuery = new DataQuery(dataFeedUrl)
            {
                ...
                Metrics = "ga:uniquePageviews",
                Sort = "ga:uniquePageviews",
                Filters = "ga:pagePath=~/index.cfm/go/checkout/do/CustomerLetter",
                //Segment = "gaid::573625486",
                GAStartDate = startDate.ToString("yyyy-MM-dd"),
                GAEndDate = endDate.ToString("yyyy-MM-dd"),
                NumberToRetrieve = 10000
        ...
        private int GetClearCart(string StartDate, string EndDate)
        {
            ...
            var dataQuery = new DataQuery(dataFeedUrl)
            {
                ...
                Metrics = "ga:uniquePageviews",
                Sort = "ga:uniquePageviews",
                Filters = "ga:pagePath=~/index.cfm/go/cart/do/clearCart/blnDialog/0",
                //Segment = "gaid::573625486",
                GAStartDate = startDate.ToString("yyyy-MM-dd"),
                GAEndDate = endDate.ToString("yyyy-MM-dd"),
                NumberToRetrieve = 10000
