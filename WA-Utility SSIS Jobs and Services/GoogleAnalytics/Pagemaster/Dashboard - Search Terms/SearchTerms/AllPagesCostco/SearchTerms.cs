    ...
    class Program
    {
       ...
       static string GetInputDateString(string[] args)
       {
        ...
        static void Main(string[] args)
        {
            ...
            VarCharFeed.Dimensions = "ga:searchKeyword,ga:hostname";
            ...
            //foreach (DataEntry pvEntry in feed.Entries)
            {
                ...
                string hostname = pvEntry.Dimensions[1].Value.Substring(0);
            ...
            string sql2 = "INSERT INTO dashboard.Search " +
                    " (RunDate, Hostname, SearchTerm, UniqueSearches, TotalResults, TermRefined, Depth, Transactions, Exits) " +
                    //" (RunDate, SearchTerm, UniqueSearches) " +
                    " VALUES ('" + date + "','" + hostname + "','" + term + "','" + unique + "','" + results + "','" + refined + "','" + depth + "','" + transactions + "','" + exits + "')";
