    ...
    class Program
    {
       ...
       static string GetInputDateString(string[] args)
       {
        ...
        static void Main(string[] args)
        {
            ...
            VarCharFeed.Ids = "ga:89500652";
            VarCharFeed.Dimensions = "ga:browser,ga:browserVersion,ga:operatingSystem,ga:operatingSystemVersion,ga:hostname";
            ...
            //foreach (DataEntry pvEntry in feed.Entries)
            {
                ...
                string hostname = pvEntry.Dimensions[4].Value.Substring(0);
            ...
            string sql2 = "INSERT INTO dashboard.BrowserOSGeneral " +
                    " (RunDate, Hostname, Browser, BrowserVersion, OperatingSystem, OperatingSystemVersion, Visits, Transactions) " +
                    //" (RunDate, SearchTerm, UniqueSearches) " +
                    " VALUES ('" + date + "','" + hostname + "','" + browser + "','" + browserversion + "','" + operatingsystem + "','" + operatingsystemversion + "','" + visits + "','" + transactions + "')";
