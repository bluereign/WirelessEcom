    ...
    class Program
    {
       ...
       static string GetInputDateString(string[] args)
       {
        ...
        static void Main(string[] args)
        {
            ...
            VarCharFeed.Dimensions = "ga:eventAction,ga:eventLabel,ga:hostname";
            ...
            //foreach (DataEntry pvEntry in feed.Entries)
            {
                ...
                string hostname = pvEntry.Dimensions[2].Value.Substring(0);
            ...
            string sql2 = "INSERT INTO dashboard.MenuBehavior " +
                    " (RunDate, Hostname, Area, Subarea, Clicks) " +
                    //" (RunDate, SearchTerm, UniqueSearches) " +
                    " VALUES ('" + date + "','" + hostname + "','" + area + "','" + subarea + "','" + visits + "')";
