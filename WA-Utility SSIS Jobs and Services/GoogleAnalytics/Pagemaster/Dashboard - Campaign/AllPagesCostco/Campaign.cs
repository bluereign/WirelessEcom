    ...
    class Program
    {
       ...
       static string GetInputDateString(string[] args)
       {
        ...
        static void Main(string[] args)
        {
            ...
            VarCharFeed.Dimensions = "ga:campaign,ga:source,ga:medium,ga:referralPath,ga:hostname";
            ...
            string sql2 = "INSERT INTO dashboard.Campaign " +
                    " (RunDate, Hostname, Campaign, Source, Medium, Referral, Traffic, Transactions) " +
                    //" (RunDate, SearchTerm, UniqueSearches) " +
                    " VALUES ('" + date + "','" + hostname + "','" + campaign + "','" + source + "','" + medium + "','" + referral + "','" + traffic + "','" + bought + "')";
