...
namespace GoogleAnalytics
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            VarCharFeed.Dimensions = "ga:pagePath,ga:hostname";
            VarCharFeed.Sort = "-ga:pageviews";
            //VarCharFeed.Segment = "gaid::66404707";
            //VarCharFeed.ExtraParameters = "key=AIzaSyAAf-WXhMC1WrgyaTPRds-sK2d1NL0GdX0";

            string date = GetInputDateString(args);
            ...
            //service.RequestFactory = GoogleAuthFix.GoogleOAutho2.GetRequestFactory();
            ...
            string sql2 = "INSERT INTO dashboard.Pageviews " +
                    " (RunDate, Hostname, PageURL, Views, Visits, Entrances, Bounces, Exits, Transactions, AvgTime) " +
                    " VALUES ('" + date + "','" + hostname + "','" + page + "','" + views + "','" + visits + "','" + bounces + "','" + entrances + "','" + exits + "','" + transactions + "','" + timeonpage + "')";
